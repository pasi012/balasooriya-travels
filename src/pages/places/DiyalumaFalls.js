...
// GALLERY IMAGES
import img1 from "../../assets/diyalumaFalls-1.jpg";
import img2 from "../../assets/diyalumaFalls-2.jpg";
import img3 from "../../assets/diyalumaFalls-3.jpg";
    ...
    return (
        <div className="w-full bg-white">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                >
                    <p>
                        The foot of the Diyaluma Falls is located 1-hour away from Ella. This 220-meter high waterfall is the 2nd highest waterfall of Sri Lanka, has different levels, and natural pools on the top. Water coming down with great force on the rocks is amazing to experience on foot but exploring the top is new and you need to be a fit to reach this. A trip to Diyaluma from Ella takes 3 to 6 hours.
                    </p>
                </div>
