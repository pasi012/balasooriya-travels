...
// GALLERY IMAGES
import img1 from "../../assets/ella-1.jpg";
import img2 from "../../assets/ella-2.jpg";
import img3 from "../../assets/ella-3.jpg";
    ...
    return (
        <div className="w-full bg-white">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                >
                    <p>
                        Ella has all the best parts of Sri Lanka rolled into one: beautiful jungle mountains, rolling tea plantations, and epic waterfalls. As one of the biggest tea producers, travelers can look forward to spending their days in the greenest surroundings, enjoying the views from hilltop houses and adventurous hiking trails. Even the train ride to Ella is one of life’s most remarkable experiences, as you travel by iconic blue train through bamboo forests and tropical mist. Enjoy all the top things to do in Ella with this complete travel guide.
                    </p>
                </div>
