...
// GALLERY IMAGES
import img1 from "../../assets/galleFace-1.jpg";
import img2 from "../../assets/galleFace-2.jpg";
import img3 from "../../assets/galleFace-3.jpg";
    ...
    return (
        <div className="w-full bg-white">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                >
                    <p>
                        Sri Lanka’s version of LA’s Venice Beach isn’t the place to get away from it all, but it is the place to relax, people watch, and have some fun with other Sri Lankans, whether it’s day or night. Aside from the beach, there’s a large grass area where people picnic and play games. For the best energy, visit on a Friday or Saturday night.
                    </p>
                </div>
