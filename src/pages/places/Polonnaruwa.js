...
// GALLERY IMAGES
import img1 from "../../assets/polonnaruwa-1.jpg";
import img2 from "../../assets/polonnaruwa-2.jpg";
import img3 from "../../assets/polonnaruwa-3.jpg";
    ...
    return (
        <div className="w-full bg-white">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                >
                    <p>
                        Polonnaruwa is an ancient city in north-central Sri Lanka, famous for its well-preserved ruins, sacred temples, and impressive stone sculptures. A UNESCO World Heritage Site, it offers visitors a fascinating glimpse into the island’s rich history, culture, and royal heritage.
                    </p>
                </div>
