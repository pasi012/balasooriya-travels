...
// GALLERY IMAGES
import img1 from "../../assets/pinnawala-1.jpg";
import img2 from "../../assets/pinnawala-2.jpg";
import img3 from "../../assets/pinnawala-3.jpg";
    ...
    return (
        <div className="w-full bg-white">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
                ...
                >
                    <p>
                        Over 15 national parks in Sri Lanka host wild elephants. Pinnawala Elephant Orphanage claims they take care of the orphanages but it actually is one of the main tourist attractions for travelers on organized tours following their Sri Lanka travel route. Pinnawala has become super popular since beautiful photos were getting shared on social media by huge influencers. We had high expectations of Pinnawala but were left with a heartbreaking experience instead.
                    </p>
                </div>
